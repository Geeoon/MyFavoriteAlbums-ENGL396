...
#' @brief calculates an artists albums ranked by release year
#' 
...
#' @brief calculates an artist's average rating and prints it
#' 
#' @param band.var the name of the band
...
#' @brief calculates an artist's number of ranked albums
#' 
#' @param band.var the name of the band
